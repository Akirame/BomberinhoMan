    ...
    private void InstantiateOnMatrix()
    {
        ...
        for (int i = 0; i < Game.Get().GetCantEnemy(); i++)
        {
            ...
            switch (Random.Range(0, 2))
                {
                case 0:
                    Instantiate(enemyPrefab1, new Vector3(randomX * 1, 0, randomZ * 1), Quaternion.identity, enemiesGroup.transform);
                    break;
                case 1:
                    Instantiate(enemyPrefab2, new Vector3(randomX * 1, 0, randomZ * 1), Quaternion.identity, enemiesGroup.transform);
                    break;
            }
        }
        //Puerta
